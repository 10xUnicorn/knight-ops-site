...
const STATIC_PAGES = [
  ...
  { path: '/for-financial-advisors', changefreq: 'monthly', priority: '0.8' },
  { path: '/for-eos-companies', changefreq: 'monthly', priority: '0.8' },
  { path: '/founder-bottleneck-score', changefreq: 'monthly', priority: '0.9' },
